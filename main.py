...
# send image message
with open("./image.jpg", "rb") as image: # insert your own image path here, read the file as binary mode
...
with open("./test.txt") as text_file: # insert your own text file path here
